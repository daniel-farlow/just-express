...
app.post('/ajax', (req, res) => {
    ...
    // res.json() is incredibly important because anytime you need to respond with JSON, and that will be very often depending on what you're building, you're gonna use res.json(), not res.send()
